...
exports.deleteGoal = handle(async (req) => { await svc.deleteGoal(req.params.id, req.user.id); return { success: true }; });
exports.submitGoals = handle(async (req) => { await svc.submitGoals(req.user.id); return { success: true }; });
